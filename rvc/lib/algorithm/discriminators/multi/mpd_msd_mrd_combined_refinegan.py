...
class MPD_MSD_MRD_Combined_RefineGan(torch.nn.Module):
    """

    This class implements a wrapper for 3 discriminators:
    MPD, MSD, MRD
    RefineGan version ~ utilizes different periods for MPD
